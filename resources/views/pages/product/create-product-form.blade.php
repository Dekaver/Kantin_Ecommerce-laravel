    ...
    <div class="flex-1 h-full max-w-4xl mx-auto overflow-hidden bg-white rounded-lg shadow-xl dark:bg-gray-800">
        <div class="flex items-center justify-center p-6 sm:p-12 md:w-full">
            <div class="w-full">
                ...
                <form method="POST" action="{{ route('shop.product.store',Auth::id())}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="flex flex-col md:flex-row-reverse">
                      ...
                      <a href="{{route('shop.product.index',Auth::id())}}" class="block m-1 px-4 py-2 mt-4 text-sm font-medium leading-5 text-center text-gray-800 transition-colors duration-150 bg-gray-50 border border-purple-600 rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
                        {{ __('cancel') }}
                      </a>
                    </div>
                </form>    
